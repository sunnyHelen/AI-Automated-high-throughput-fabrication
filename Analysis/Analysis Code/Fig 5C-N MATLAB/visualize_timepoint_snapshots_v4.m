...
config.videoIndex.GroundTruth = 2;   % Use 1st Ground Truth video
config.videoIndex.Clot = 2;          % Use 1st Clot video
config.videoIndex.Sora = 1;          % Use 1st Sora video
config.videoIndex.Hailuo = 5;        % Use 1st Hailuo video
config.videoIndex.Hunyuan = 5;       % Use 1st Hunyuan video
config.videoIndex.Kling = 5;         % Use 1st Kling video
config.videoIndex.Seedance = 2;      % Use 1st Seedance video
config.videoIndex.Wan = 1;           % Use 1st Wan video
...
config.analysisCropCenterX = 256;  % X center of crop region (in 512x512 coordinates)
config.analysisCropCenterY = 270;  % Y center of crop region (in 512x512 coordinates)
...
config.figureRotation = 0;  % Rotate 90 degrees clockwise
