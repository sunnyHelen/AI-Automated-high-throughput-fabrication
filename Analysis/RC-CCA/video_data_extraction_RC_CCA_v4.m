...
config.intensityCropCenterX = 400;  % X center (bottom-left origin, 512x512 coordinates)
config.intensityCropCenterY = 325;  % Y center (bottom-left origin, 512x512 coordinates)
...
config.referenceGTVideo = 'RC-CCA-GT-0';  % e.g., 'JH-ICA-GT-1'
...
config.debugVideoName = 'RC-CCA-Clot-0';  % Video filename to inspect (without .mp4)
