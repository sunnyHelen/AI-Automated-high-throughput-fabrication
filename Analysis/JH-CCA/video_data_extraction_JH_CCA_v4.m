...
config.intensityCropCenterY = 256;  % Y center (bottom-left origin, 512x512 coordinates)
...
config.referenceGTVideo = 'JH-CCA-GT-1';  % e.g., 'JH-ICA-GT-1'

% DEBUG VISUALIZATION - Set to true to enable debug plots
config.debugVisualization = false;  % Set to false to disable

% Debug parameters (only used if debugVisualization = true)
config.debugVideoName = 'JH-CCA-Clot-0';  % Video filename to inspect (without .mp4)
